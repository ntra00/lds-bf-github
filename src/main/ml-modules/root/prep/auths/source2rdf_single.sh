...
yaz-record-conv $AUTH2BFDIR/auths-conv.xml $SOURCE_UNPROCESSED/single/$LCCN.xml |  sed -e "s|idwebvlcp03.loc.gov|id.loc.gov|g" | sed -e "s|mlvlp04.loc.gov:8080|id.loc.gov|g" > $SOURCE_PROCESSED/single/$LCCN.rdf
