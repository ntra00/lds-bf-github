...
declare  function local:fix($d,$batch) {
	...
	let $title-lang:=fn:substring-after(fn:string($work/bf:title[1]/bf:Title[1]/*[self::* instance of element(bflc:title00MarcKey) or self::* instance of element(bflc:title10MarcKey) or self::* instance of element(bflc:title11MarcKey) or self::* instance of element(bflc:title30MarcKey)  or  self::* instance of element(bflc:title40MarcKey)][1]),"$l")
