...
<xsl:stylesheet exclude-result-prefixes="xlink marc" version="1.0" default-validation="strip" input-type-annotations="unspecified" xmlns="http://www.loc.gov/mods/v3" xmlns:lclocal="http://rs5.loc.gov:8081/ammem/lclocal_xml/document.xsd" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:marc="http://www.loc.gov/MARC21/slim" xmlns:amnm="http://memory.loc.gov:8081/ammem/dave/xml/amnm" xmlns:xlink="http://www.w3.org/1999/xlink">
    <xsl:include href="MARC21slimUtils.xsl"/>
    <xsl:output encoding="UTF-8" indent="yes" method="xml"/>

  <!-- Maintenance note: 
       For each revision, change the content of <recordInfo><recordOrigin> 
       to reflect the stylesheet name and the new revision number.
  -->

  <!--lcMARC21slim2MODS3-3 (Revision 1.52) tmee 20100218
      
      Revision 1.52 - LC-centric changes for MARC 037 050 710 856 859 985 2010/02/05 tmee
      ...
      Revision 1.40 - Dropped <note> for 510 and added <relatedItem type="isReferencedBy"> for 510 2010/02/05 tmee
  ...
  -->
    ...
    <!-- 1.52 lc050 tmee 20100203-->
        <xsl:for-each select="marc:datafield[@tag=050]">
            <xsl:choose>
                <xsl:when test="($leader6='g' or $leader6='i' or $leader6='j' or $leader6='k' or $leader6='o' or $leader6='p' or $leader6='r') or (($leader6='i' or $leader6='j') and not(starts-with(marc:subfield[@code=a], 'M')))">
                    <location>
                        <shelfLocator>
                            <xsl:value-of select="marc:subfield[@code='a']" disable-output-escaping="no"/>
    ...
    <!-- 1.52 lc037 tmee 20100203-->
        <xsl:for-each select="marc:datafield[@tag='037']">
            <xsl:choose>
                <xsl:when test="$leader6='k'">
                    <identifier type="reproduction number">
                        <xsl:attribute name="displayLabel">
    ...
    <!-- 1.52 lc985  tmee  20100202 -->
        <extension>
            <xsl:for-each select="marc:datafield[@tag=985][marc:subfield[@code='a']]">
                <relatedItem type="recordGroup">
                    <identifier type="recordgroupID">
                        <xsl:value-of select="marc:subfield[@code='a']" disable-output-escaping="no"/>
                    </identifier>
                </relatedItem>
            </xsl:for-each>

      <!-- 1.52 lc856  tmee  20100202 -->
            <xsl:for-each select="marc:datafield[@tag=856][marc:subfield[@code='d' or 'q']]">
                <xsl:choose>
                    <xsl:when test="marc:subfield[@code='3'] and count(marc:subfield[@code='f'])=1">
                        <lclocal:digObj>
                            <xsl:for-each select="marc:subfield[@code='3']">
                                <lclocal:caption>
                                    <xsl:value-of select="." disable-output-escaping="no"/>
                            ...
                            <xsl:if test="marc:subfield[@code='d' or 'f']">
                                <lclocal:digObjRef>
                                    <xsl:for-each select="marc:subfield[@code='d']">
                                        <lclocal:aggregate>
                                            <xsl:value-of select="." disable-output-escaping="no"/>
                            ...
                            <xsl:for-each select="marc:subfield[@code='q']">
                                <lclocal:displayTypeCode>
                                    <xsl:value-of select="." disable-output-escaping="no"/>
                                </lclocal:displayTypeCode>
                            </xsl:for-each>
                            <xsl:choose>
                                <xsl:when test="marc:subfield[@code='q']='u'">
                                    <lclocal:digObjExtLocation access="object in context">
                                        <url>
                                            <xsl:value-of select="marc:subfield[@code='u']" disable-output-escaping="no"/>
                                        </url>
                                    </lclocal:digObjExtLocation>
                                </xsl:when>
                                <xsl:otherwise>
                                    <location>
                                        <url>
                                    ...
                                    <lclocal:handleInformation>
                                        <xsl:choose>
                                            <xsl:when test="starts-with(marc:subfield[@code='u'],'http://hdl.loc.gov/')">
                                                <xsl:value-of select="concat('hdl:', substring-after(marc:subfield[@code='u'],'http://hdl.loc.gov/'))" disable-output-escaping="no"/>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <xsl:value-of select="." disable-output-escaping="no"/>
	  ...
	  <!-- 1.52 lc856 assumes up to 11 fs  tmee  20100217 -->
                    <xsl:otherwise>
                        <xsl:if test="count(marc:subfield[@code='f'][1])">
                            <lclocal:digObj>
                                <lclocal:caption>Part 1 of <xsl:value-of select="count(marc:subfield[@code='f'])" disable-output-escaping="no"/>
                                </lclocal:caption>
                                <lclocal:digObjRef>
                                    <xsl:for-each select="marc:subfield[@code='d']">
                                        <lclocal:aggregate>
                                    ...
                                    <xsl:for-each select="marc:subfield[@code='f'][1]">
                                        <lclocal:digitalID>
                                            <xsl:value-of select="." disable-output-escaping="no"/>
                                        </lclocal:digitalID>
                                    </xsl:for-each>
                        ...
                        <xsl:if test="count(marc:subfield[@code='f'][2])">
                            <lclocal:digObj>
                                <lclocal:caption>Part 2 of <xsl:value-of select="count(marc:subfield[@code='f'])" disable-output-escaping="no"/>
                                </lclocal:caption>
                                <lclocal:digObjRef>
                                    <xsl:for-each select="marc:subfield[@code='d']">
                                        <lclocal:aggregate>
                                    ...
                                    <xsl:for-each select="marc:subfield[@code='f'][2]">
                                        <lclocal:digitalID>
                                            <xsl:value-of select="." disable-output-escaping="no"/>
                                        </lclocal:digitalID>
                                    </xsl:for-each>
                        ...
                        <xsl:if test="count(marc:subfield[@code='f'][3])">
                            <lclocal:digObj>
                                <lclocal:caption>Part 3 of <xsl:value-of select="count(marc:subfield[@code='f'])" disable-output-escaping="no"/>
                                </lclocal:caption>
                                <lclocal:digObjRef>
                                    <xsl:for-each select="marc:subfield[@code='d']">
                                        <lclocal:aggregate>
                                    ...
                                    <xsl:for-each select="marc:subfield[@code='f'][3]">
                                        <lclocal:digitalID>
                                            <xsl:value-of select="." disable-output-escaping="no"/>
                                        </lclocal:digitalID>
                                    </xsl:for-each>
                        ...
                        <xsl:if test="count(marc:subfield[@code='f'][4])">
                            <lclocal:digObj>
                                <lclocal:caption>Part 4 of <xsl:value-of select="count(marc:subfield[@code='f'])" disable-output-escaping="no"/>
                                </lclocal:caption>
                                <lclocal:digObjRef>
                                    <xsl:for-each select="marc:subfield[@code='d']">
                                        <lclocal:aggregate>
                                    ...
                                    <xsl:for-each select="marc:subfield[@code='f'][4]">
                                        <lclocal:digitalID>
                                            <xsl:value-of select="." disable-output-escaping="no"/>
                                        </lclocal:digitalID>
                                    </xsl:for-each>
                        ...
                        <xsl:if test="count(marc:subfield[@code='f'][5])">
                            <lclocal:digObj>
                                <lclocal:caption>Part 5 of <xsl:value-of select="count(marc:subfield[@code='f'])" disable-output-escaping="no"/>
                                </lclocal:caption>
                                <lclocal:digObjRef>
                                    <xsl:for-each select="marc:subfield[@code='d']">
                                        <lclocal:aggregate>
                                    ...
                                    <xsl:for-each select="marc:subfield[@code='f'][5]">
                                        <lclocal:digitalID>
                                            <xsl:value-of select="." disable-output-escaping="no"/>
                                        </lclocal:digitalID>
                                    </xsl:for-each>
                        ...
                        <xsl:if test="count(marc:subfield[@code='f'][6])">
                            <lclocal:digObj>
                                <lclocal:caption>Part 6 of <xsl:value-of select="count(marc:subfield[@code='f'])" disable-output-escaping="no"/>
                                </lclocal:caption>
                                <lclocal:digObjRef>
                                    <xsl:for-each select="marc:subfield[@code='d']">
                                        <lclocal:aggregate>
                                    ...
                                    <xsl:for-each select="marc:subfield[@code='f'][6]">
                                        <lclocal:digitalID>
                                            <xsl:value-of select="." disable-output-escaping="no"/>
                                        </lclocal:digitalID>
                                    </xsl:for-each>
                        ...
                        <xsl:if test="count(marc:subfield[@code='f'][7])">
                            <lclocal:digObj>
                                <lclocal:caption>Part 7 of <xsl:value-of select="count(marc:subfield[@code='f'])" disable-output-escaping="no"/>
                                </lclocal:caption>
                                <lclocal:digObjRef>
                                    <xsl:for-each select="marc:subfield[@code='d']">
                                        <lclocal:aggregate>
                                    ...
                                    <xsl:for-each select="marc:subfield[@code='f'][7]">
                                        <lclocal:digitalID>
                                            <xsl:value-of select="." disable-output-escaping="no"/>
                                        </lclocal:digitalID>
                                    </xsl:for-each>
                        ...
                        <xsl:if test="count(marc:subfield[@code='f'][8])">
                            <lclocal:digObj>
                                <lclocal:caption>Part 8 of <xsl:value-of select="count(marc:subfield[@code='f'])" disable-output-escaping="no"/>
                                </lclocal:caption>
                                <lclocal:digObjRef>
                                    <xsl:for-each select="marc:subfield[@code='d']">
                                        <lclocal:aggregate>
                                    ...
                                    <xsl:for-each select="marc:subfield[@code='f'][8]">
                                        <lclocal:digitalID>
                                            <xsl:value-of select="." disable-output-escaping="no"/>
                                        </lclocal:digitalID>
                                    </xsl:for-each>
                        ...
                        <xsl:if test="count(marc:subfield[@code='f'][9])">
                            <lclocal:digObj>
                                <lclocal:caption>Part 9 of <xsl:value-of select="count(marc:subfield[@code='f'])" disable-output-escaping="no"/>
                                </lclocal:caption>
                                <lclocal:digObjRef>
                                    <xsl:for-each select="marc:subfield[@code='d']">
                                        <lclocal:aggregate>
                                    ...
                                    <xsl:for-each select="marc:subfield[@code='f'][9]">
                                        <lclocal:digitalID>
                                            <xsl:value-of select="." disable-output-escaping="no"/>
                                        </lclocal:digitalID>
                                    </xsl:for-each>
                        ...
                        <xsl:if test="count(marc:subfield[@code='f'][10])">
                            <lclocal:digObj>
                                <lclocal:caption>Part 10 of <xsl:value-of select="count(marc:subfield[@code='f'])" disable-output-escaping="no"/>
                                </lclocal:caption>
                                <lclocal:digObjRef>
                                    <xsl:for-each select="marc:subfield[@code='d']">
                                        <lclocal:aggregate>
                                    ...
                                    <xsl:for-each select="marc:subfield[@code='f'][10]">
                                        <lclocal:digitalID>
                                            <xsl:value-of select="." disable-output-escaping="no"/>
                                        </lclocal:digitalID>
                                    </xsl:for-each>
                        ...
                        <xsl:if test="count(marc:subfield[@code='f'][11])">
                            <lclocal:digObj>
                                <lclocal:caption>Part 11 of <xsl:value-of select="count(marc:subfield[@code='f'])" disable-output-escaping="no"/>
                                </lclocal:caption>
                                <lclocal:digObjRef>
                                    <xsl:for-each select="marc:subfield[@code='d']">
                                        <lclocal:aggregate>
                                    ...
                                    <xsl:for-each select="marc:subfield[@code='f'][11]">
                                        <lclocal:digitalID>
                                            <xsl:value-of select="." disable-output-escaping="no"/>
                                        </lclocal:digitalID>
                                    </xsl:for-each>
    ...
    <!-- 1.52 lc859  tmee  20100217 -->
        <xsl:for-each select="marc:datafield[@tag=859]">
            <xsl:choose>
                <xsl:when test="starts-with(marc:subfield[@code='3'],'Issued as part of') or starts-with(marc:subfield[@code='3'],'Selections from')">
                    <relatedItem type="host">
                        <xsl:choose>
                        ...
                        <xsl:choose>
                            <xsl:when test="starts-with(marc:subfield[@code='u'],'http://hdl.loc.gov/loc.music/')">
                                <titleInfo>
                                    <title>
                        ...
                        <xsl:if test="starts-with(marc:subfield[@code='u'],'http://hdl.loc.gov')">
                            <extension>
                                <xsl:for-each select="marc:subfield[@code='3']">
                                    <lclocal:caption>
                                        <xsl:value-of select="." disable-output-escaping="no"/>
                                ...
                                <xsl:for-each select="marc:subfield[@code='u']">
                                    <lclocal:handleInformation>
                                        <xsl:choose>
                                            <xsl:when test="starts-with(.,'http://hdl.loc.gov/')">
                                                <xsl:value-of select="concat('hdl:', substring-after(.,'http://hdl.loc.gov/'))" disable-output-escaping="no"/>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <xsl:value-of select="." disable-output-escaping="no"/>
                                            </xsl:otherwise>
                            ...
                            <xsl:otherwise>
                                ...
                                <extension>
                                    ...
                                    <xsl:for-each select="marc:subfield[@code='u']">
                                        <lclocal:handleInformation>
                                            <xsl:choose>
                                                <xsl:when test="starts-with(text(),'http://hdl.loc.gov/')">
                                                    <xsl:value-of select="concat('hdl:', substring-after(.,'http://hdl.loc.gov/'))" disable-output-escaping="no"/>
                                                </xsl:when>
                                                <xsl:otherwise>
                                                    <xsl:value-of select="." disable-output-escaping="no"/>
    ...
    <!-- 1.52 lc710  tmee  20100203-->
        <xsl:for-each select="marc:datafield[@tag=710]">
            <xsl:if test="contains(marc:subfield[@code='a'],'Collection (Library of Congress)')">
                <relatedItem type="host">
                    <titleInfo>
                        <title>
                            <xsl:value-of select="marc:subfield[@code='a']" disable-output-escaping="no"/>
    ...
    <!-- 1.24  tmee  -->
      ...
      <!-- 1.25  tmee-->
            ...
            <recordOrigin>Converted from MARCXML to MODS version 3.3 using lcMARC21slim2MODS3-3.xsl
      (Revision 1.52)</recordOrigin>
  ...
  <!-- 1.27 tmee-->
    ...
    <xsl:template match="marc:datafield[@tag=650]" as="item()*">
        <subject>
            <xsl:call-template name="subjectAuthority"/>
            <topic>
                <xsl:call-template name="chopPunctuation">
    ...
    <xsl:template match="marc:datafield[@tag=653]" as="item()*">
        <subject>
            <xsl:for-each select="marc:subfield[@code='a']">
                <topic>
                    <xsl:value-of select="." disable-output-escaping="no"/>
