...
<xsl:stylesheet exclude-result-prefixes="xlink marc" version="2.0" default-validation="strip" input-type-annotations="unspecified" xmlns="http://www.loc.gov/mods/v3" xmlns:marc="http://www.loc.gov/MARC21/slim" xmlns:mods="http://www.loc.gov/mods/v3" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:include href="MARC21slimUtils.xsl"/>
	<xsl:output encoding="UTF-8" indent="yes" method="xml"/>
	<xsl:strip-space elements="*"/>

	<!-- Maintenance note: For each revision, change the content of <recordInfo><recordOrigin> to reflect the new revision number.
	MARC21slim2MODS3-4 (Revision 1.71) 20110701

Revision 1.71 - Added mapping for 985 record numbers into identifier type=membership 
				!!!!!!!!!!!!!!!(985 makes it different from the std loc stylesheet)!!!!!!!!!!!!!!!!
				Fixed empty frequency and 610 subject titles 2011/07/01 - ntra
	...
	<xsl:template match="/" as="item()*">
		...
		<xsl:choose>
			<xsl:when test="//marc:collection">
				<modsCollection xsi:schemaLocation="http://www.loc.gov/mods/v3 http://www.loc.gov/standards/mods/v3/mods-3-4.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
			...
			<xsl:otherwise>
				<mods version="3.4" xsi:schemaLocation="http://www.loc.gov/mods/v3 http://www.loc.gov/standards/mods/v3/mods-3-4.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">				
...
-->
		...
		<originInfo>
			...
			<xsl:variable name="frequency">							
					...
					<frequency>
				<xsl:value-of select="$frequency" disable-output-escaping="no"/>
				</frequency>
				</xsl:if>
				...
				<xsl:when test="$hit='260'">
					<originInfo>
						...
						<xsl:if test="marc:subfield[@code='c']">
							<dateIssued>
								<xsl:value-of select="marc:subfield[@code='c']" disable-output-escaping="no"/>
							</dateIssued>
						</xsl:if>
						<xsl:if test="marc:subfield[@code='g']">
							<dateCreated>
								<xsl:value-of select="marc:subfield[@code='g']" disable-output-escaping="no"/>
							</dateCreated>
						</xsl:if>
						<xsl:for-each select="../marc:datafield[@tag=880]/marc:subfield[@code=6][contains(text(),'250')]">
							<edition>
								<xsl:value-of select="following-sibling::marc:subfield" disable-output-escaping="no"/>
							</edition>
						</xsl:for-each>
					</originInfo>
				</xsl:when>
		...
		<xsl:variable name="physicalDescription">
			...
			<xsl:if test="marc:datafield[@tag=246]/marc:subfield[@code='h']">
				<form authority="gmd">
					<xsl:call-template name="chopBrackets">
						<xsl:with-param name="chopString">
							<xsl:value-of select="marc:datafield[@tag=246]/marc:subfield[@code='h']" disable-output-escaping="no"/>
						</xsl:with-param>
					</xsl:call-template>
				</form>
			</xsl:if>
		...
		<!-- 856, 020, 024, 022, 028, 010, 035, 037 , 985 -->
		...
		<xsl:for-each select="marc:datafield[@tag='010'][marc:subfield[@code='z']]">
			<identifier type="lccn" invalid="yes">
				<xsl:value-of select="normalize-space(marc:subfield[@code='z'])" disable-output-escaping="no"/>
			</identifier>
		</xsl:for-each>
		...
		<xsl:for-each select="marc:datafield[@tag='035'][marc:subfield[@code='a'][contains(text(), '(OCoLC)')]]">
			<identifier type="oclc">
				<xsl:value-of select="normalize-space(substring-after(marc:subfield[@code='a'], '(OCoLC)'))" disable-output-escaping="no"/>
			</identifier>
		</xsl:for-each>
...
<xsl:apply-templates select="marc:datafield[@tag='985']/marc:subfield[@code='a' or @code='e']"/>
	...
	<xsl:template name="relatedItem510" as="item()*">
	...
	<xsl:template name="relatedOriginInfo510" as="item()*">
		<xsl:for-each select="marc:subfield[@code='b']">
			<originInfo>
	...
	<xsl:template name="scriptCode" as="item()*">
	...
	<xsl:template name="xxx880" as="item()*">
		<xsl:if test="child::marc:subfield[@code='6']">
			...
			<xsl:if test="//marc:datafield/marc:subfield[@code='6']">
				<xsl:attribute name="altRepGroup">
					<xsl:value-of select="$sf06b" disable-output-escaping="no"/>
				</xsl:attribute>
				<xsl:attribute name="script">
					<xsl:choose>
						<xsl:when test="$scriptCode=''">Latn</xsl:when>
	...
	<xsl:template name="yyy880" as="item()*">
	...
	<xsl:template name="z2xx880" as="item()*">
		...
		<xsl:variable name="x260">
			<xsl:choose>
				<xsl:when test="@tag='260' and marc:subfield[@code='6']">
					...
					<xsl:value-of select="$sf06260b" disable-output-escaping="no"/>
				</xsl:when>
		...
		<xsl:variable name="x250">
			<xsl:choose>
				<xsl:when test="@tag='250' and marc:subfield[@code='6']">
					...
					<xsl:value-of select="$sf06250b" disable-output-escaping="no"/>
				</xsl:when>
		...
		<xsl:choose>
			<xsl:when test="$x250!='' and $x260!=''">
				<xsl:attribute name="altRepGroup">
					<xsl:value-of select="concat($x250, $x260)" disable-output-escaping="no"/>
				</xsl:attribute>
			</xsl:when>
			<xsl:when test="$x250!=''">
				<xsl:attribute name="altRepGroup">
					<xsl:value-of select="$x250" disable-output-escaping="no"/>
				</xsl:attribute>
			</xsl:when>
			<xsl:when test="$x260!=''">
				<xsl:attribute name="altRepGroup">
					<xsl:value-of select="$x260" disable-output-escaping="no"/>
				</xsl:attribute>
			</xsl:when>
		</xsl:choose>
	...
	<xsl:template name="z3xx880" as="item()*">
		...
		<xsl:variable name="x300">
			<xsl:choose>
				<xsl:when test="@tag='300' and marc:subfield[@code='6']">
					...
					<xsl:value-of select="$sf06300b" disable-output-escaping="no"/>
				</xsl:when>
		...
		<xsl:variable name="x351">
			<xsl:choose>
				<xsl:when test="@tag='351' and marc:subfield[@code='6']">
					...
					<xsl:value-of select="$sf06351b" disable-output-escaping="no"/>
				</xsl:when>
		...
		<xsl:choose>
			<xsl:when test="$x351!='' and $x300!=''">
				<xsl:attribute name="altRepGroup">
					<xsl:value-of select="concat($x351, $x300)" disable-output-escaping="no"/>
				</xsl:attribute>
			</xsl:when>
			<xsl:when test="$x351!=''">
				<xsl:attribute name="altRepGroup">
					<xsl:value-of select="$x351" disable-output-escaping="no"/>
				</xsl:attribute>
			</xsl:when>
			<xsl:when test="$x300!=''">
				<xsl:attribute name="altRepGroup">
					<xsl:value-of select="$x300" disable-output-escaping="no"/>
				</xsl:attribute>
			</xsl:when>
		</xsl:choose>
		<xsl:if test="//marc:datafield/marc:subfield[@code='6']"> </xsl:if>
	...
	<xsl:template name="true880" as="item()*">
	...
	<xsl:template match="marc:datafield" mode="trans880" as="item()*">
	...
	<!-- 130 -->
	<xsl:template name="createTitleInfoFrom130" as="item()*">
	...
	<xsl:template name="createTitleInfoFrom730" as="item()*">
		<titleInfo type="uniform">
			<title>
				<xsl:variable name="str">
					<xsl:for-each select="marc:subfield">
	...
	<xsl:template name="createTitleInfoFrom210" as="item()*">
		<titleInfo type="abbreviated">
	...
	<xsl:template name="createTitleInfoFrom245" as="item()*">
		<titleInfo>
			<xsl:call-template name="xxx880"/>
			<xsl:variable name="title">
				<xsl:choose>
	...
	<xsl:template name="createTitleInfoFrom246" as="item()*">
	...
	<xsl:template name="createTitleInfoFrom240" as="item()*">
		<titleInfo type="uniform">
	...
	<xsl:template name="createTitleInfoFrom740" as="item()*">
		<titleInfo type="alternative">
			<xsl:call-template name="xxx880"/>
			<title>
				<xsl:call-template name="chopPunctuation">
	...
	<xsl:template name="createNameFrom100" as="item()*">
		<name type="personal">
	...
	<xsl:template name="createNameFrom110" as="item()*">
		<name type="corporate">
			<xsl:call-template name="xxx880"/>
			<xsl:if test="//marc:datafield[@tag='240']">
				<xsl:attribute name="nameTitleGroup">
	...
	<xsl:template name="createNameFrom111" as="item()*">
		<name type="conference">
			<xsl:call-template name="xxx880"/>
			<xsl:if test="//marc:datafield[@tag='240']">
				<xsl:attribute name="nameTitleGroup">
	...
	<xsl:template name="createNameFrom700" as="item()*">
		<name type="personal">
			<xsl:call-template name="xxx880"/>
			<xsl:call-template name="nameABCDQ"/>
			<xsl:call-template name="affiliation"/>
	...
	<xsl:template name="createNameFrom710" as="item()*">
		<name type="corporate">
			<xsl:call-template name="xxx880"/>
			<xsl:call-template name="nameABCDN"/>
			<xsl:call-template name="role"/>
	...
	<xsl:template name="createNameFrom711" as="item()*">
		<name type="conference">
			<xsl:call-template name="xxx880"/>
			<xsl:call-template name="nameACDEQ"/>
			<xsl:call-template name="role"/>
	...
	<xsl:template name="createNameFrom720" as="item()*">
	...
	<xsl:template name="createGenreFrom047" as="item()*">
	...
	<xsl:template name="createGenreFrom655" as="item()*">
		<genre authority="marcgt">
			<xsl:attribute name="authority">
				<xsl:value-of select="marc:subfield[@code='2']" disable-output-escaping="no"/>
			</xsl:attribute>
	...
	<xsl:template name="createTOCFrom505" as="item()*">
		<tableOfContents>
			<xsl:call-template name="xxx880"/>
			<xsl:call-template name="uri"/>
			<xsl:call-template name="subfieldSelect">
	...
	<xsl:template name="createAbstractFrom520" as="item()*">
		<abstract>
			<xsl:call-template name="xxx880"/>
			<xsl:call-template name="uri"/>
			<xsl:call-template name="subfieldSelect">
	...
	<xsl:template name="createTargetAudienceFrom521" as="item()*">
		<targetAudience>
			<xsl:call-template name="xxx880"/>
			<xsl:call-template name="subfieldSelect">
				<xsl:with-param name="codes">ab</xsl:with-param>
	...
	<xsl:template name="createNoteFrom245c" as="item()*">
		<xsl:choose>
	...
	<xsl:template name="createNoteFrom362" as="item()*">
	...
	<xsl:template name="createNoteFrom500" as="item()*">
		<note>
			<xsl:call-template name="xxx880"/>
			<xsl:call-template name="uri"/>
			<xsl:value-of select="marc:subfield[@code='a']" disable-output-escaping="no"/>
	...
	<xsl:template name="createNoteFrom502" as="item()*">
		<note type="thesis">
			<xsl:call-template name="xxx880"/>
			<xsl:call-template name="uri"/>
			<xsl:variable name="str">
	...
	<xsl:template name="createNoteFrom504" as="item()*">
	...
	<xsl:template name="createNoteFrom508" as="item()*">
	...
	<xsl:template name="createNoteFrom511" as="item()*">
	...
	<xsl:template name="createNoteFrom515" as="item()*">
		<note type="numbering">
			<xsl:call-template name="xxx880"/>
			<xsl:call-template name="uri"/>
			<xsl:variable name="str">
	...
	<xsl:template name="createNoteFrom518" as="item()*">
		<note type="venue">
			<xsl:call-template name="xxx880"/>
			<xsl:call-template name="uri"/>
			<xsl:variable name="str">
	...
	<xsl:template name="createNoteFrom524" as="item()*">
	...
	<xsl:template name="createNoteFrom530" as="item()*">
	...
	<xsl:template name="createNoteFrom533" as="item()*">
	...
	<xsl:template name="createNoteFrom534" as="item()*">
	...
	<xsl:template name="createNoteFrom535" as="item()*">
	...
	<xsl:template name="createNoteFrom536" as="item()*">
		<note type="funding">
			<xsl:call-template name="xxx880"/>
			<xsl:call-template name="uri"/>
			<xsl:variable name="str">
	...
	<xsl:template name="createNoteFrom538" as="item()*">
	...
	<xsl:template name="createNoteFrom541" as="item()*">
	...
	<xsl:template name="createNoteFrom545" as="item()*">
	...
	<xsl:template name="createNoteFrom546" as="item()*">
		<note type="language">
			<xsl:call-template name="xxx880"/>
			<xsl:call-template name="uri"/>
			<xsl:variable name="str">
	...
	<xsl:template name="createNoteFrom561" as="item()*">
		<note type="ownership">
			<xsl:call-template name="xxx880"/>
			<xsl:call-template name="uri"/>
			<xsl:variable name="str">
	...
	<xsl:template name="createNoteFrom562" as="item()*">
	...
	<xsl:template name="createNoteFrom581" as="item()*">
	...
	<xsl:template name="createNoteFrom583" as="item()*">
		<note type="action">
			<xsl:call-template name="xxx880"/>
			<xsl:call-template name="uri"/>
			<xsl:variable name="str">
	...
	<xsl:template name="createNoteFrom585" as="item()*">
	...
	<xsl:template name="createNoteFrom5XX" as="item()*">
		<note>
			<xsl:call-template name="xxx880"/>
			<xsl:call-template name="uri"/>
			<xsl:variable name="str">
	...
	<xsl:template name="createSubGeoFrom034" as="item()*">
	...
	<xsl:template name="createSubGeoFrom043" as="item()*">
		<subject>
			<xsl:call-template name="xxx880"/>
	...
	<xsl:template name="createSubGeoFrom255" as="item()*">
		<subject>
			<xsl:call-template name="xxx880"/>
			<xsl:for-each select="marc:subfield[@code='a' or @code='b' or @code='c']">
				<cartographics>
	...
	<xsl:template name="createSubNameFrom600" as="item()*">
		<subject>
			<xsl:call-template name="xxx880"/>
	...
	<xsl:template name="createSubNameFrom610" as="item()*">
		<subject>
			<xsl:call-template name="xxx880"/>
			<xsl:call-template name="subjectAuthority"/>
			<name type="corporate">
	...
	<xsl:template name="createSubNameFrom611" as="item()*">
		<subject>
			<xsl:call-template name="xxx880"/>
			<xsl:call-template name="subjectAuthority"/>
			<name type="conference">
	...
	<xsl:template name="createSubTitleFrom630" as="item()*">
		<subject>
			<xsl:call-template name="xxx880"/>
			<xsl:call-template name="subjectAuthority"/>
			<titleInfo>
	...
	<xsl:template name="createSubChronFrom648" as="item()*">
		<subject>
			<xsl:call-template name="xxx880"/>
			<xsl:if test="marc:subfield[@code=2]">
				<xsl:attribute name="authority">
	...
	<xsl:template name="createSubTopFrom650" as="item()*">
		<subject>
			<xsl:call-template name="xxx880"/>
			<xsl:call-template name="subjectAuthority"/>
			<topic>
	...
	<xsl:template name="createSubGeoFrom651" as="item()*">
		<subject>
			<xsl:call-template name="xxx880"/>
			<xsl:call-template name="subjectAuthority"/>
			<xsl:for-each select="marc:subfield[@code='a']">
	...
	<xsl:template name="createSubFrom653" as="item()*">
		<subject>
			<xsl:call-template name="xxx880"/>
			<xsl:for-each select="marc:subfield[@code='a']">
				<topic>
	...
	<xsl:template name="createSubFrom656" as="item()*">
		<subject>
			<xsl:call-template name="xxx880"/>
			<xsl:if test="marc:subfield[@code=2]">
				<xsl:attribute name="authority">
	...
	<xsl:template name="createSubGeoFrom662752" as="item()*">
		<subject>
			<xsl:call-template name="xxx880"/>
	...
	<xsl:template name="createSubTemFrom045" as="item()*">
	...
	<xsl:template name="createClassificationFrom050" as="item()*">
		<xsl:for-each select="marc:subfield[@code='b']">
	...
	<xsl:template name="createClassificationFrom060" as="item()*">
	...
	<xsl:template name="createClassificationFrom080" as="item()*">
	...
	<xsl:template name="createClassificationFrom082" as="item()*">
	...
	<xsl:template name="createClassificationFrom084" as="item()*">
		<classification>
			<xsl:attribute name="authority">
				<xsl:value-of select="marc:subfield[@code='2']" disable-output-escaping="no"/>
			</xsl:attribute>
	...
	<xsl:template name="createClassificationFrom086" as="item()*">
	...
	<xsl:template name="createRelatedItemFrom490" as="item()*">
		<relatedItem type="series">
			<xsl:call-template name="xxx880"/>
			<titleInfo>
				<title>
	...
	<xsl:template name="createLocationFrom852" as="item()*">
		<location>
	...
	<xsl:template name="createLocationFrom856" as="item()*">
	...
	<xsl:template name="createAccessConditionFrom506" as="item()*">
	...
	<xsl:template name="createAccessConditionFrom540" as="item()*">
...
<xsl:template match="marc:datafield[@tag='985']/marc:subfield[@code='a' or @code='e'] " as="item()*">
				<identifier type="membership">
					<xsl:value-of select="." disable-output-escaping="no"/>
				</identifier>
			</xsl:template>
</xsl:stylesheet>