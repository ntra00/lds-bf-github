...
declare function lp:param-string($params as element(param:params)) as xs:string? {
    let $param-parts :=
        ...
        return
           (: concat($param/param:name/text(), "=", encode-for-uri($param/param:value/text())) :)
            concat($param/param:name/text(), "=", $param/param:value/text())
    return    
                ...
                element param:params {
                    ...
                    return
                        ...
                        element param:param {
                            ...
                            element param:value {encode-for-uri( xs:string($value) )}
                        }
                }            
