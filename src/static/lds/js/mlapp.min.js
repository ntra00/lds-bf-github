...
/** MarkLogic Application Java script : Closure compiled code */
function setRelLinks(){$("a").click(function(a){var b=$(this).attr("rel");if(b!=null&&b!=""){a.preventDefault();$.address.value(b)}})}function toggleFacetBox(a,b){a.text()=="+"?a.text("-"):a.text("+");$("div.content[id="+b+"]").toggle(200)}function initFacetToggles(){$("span.title-toggle > a").each(function(){$(this).toggleClass("hidden");$(this).click(function(a){a.preventDefault();a=$(this).attr("id");toggleFacetBox($(this),a)})})}
function setUpEntityEvents(){$("span.entity","#content").each(function(){$(this).click(function(a){a.preventDefault()})})}function paramVal(a,b){var c=a.indexOf(b+"=");if(c==-1)return"";var d=a.indexOf("&",c);c=d==-1?a.substring(c):a.substring(c,d);return c.substring(c.indexOf("=")+1)}
function setupSearch(){var a=$("#search-text",".search-box");a.autocomplete({minLength:3,delay:750,source:function(b,c){var d=$("#search-text",".search-box").val();$.get("/suggest.xqy?term="+escape(d),function(e){c(e.split(","))})}});a.keyup(function(b){if(b.keyCode==13){b.preventDefault();submitSearchText()}});$("#button",".search-box").button();$("a.search-submit",".search-box").click(function(b){b.preventDefault();submitSearchText()})}
function initFacetDate(){$(".datepicker").each(function(){$(this).datepicker({constrainInput:true,changeMonth:true,changeYear:true})});$("button.facet-date-submit",".facet-box").each(function(){var a=$(this).attr("id"),b=a+"1",c=a+"2",d=$(this).attr("rel");$(this).button();$(this).click(function(){var e=$(".datepicker","#dateafter"),f=$(".datepicker","#datebefore");e.datepicker("option","constrainInput",true);f.datepicker("option","constrainInput",true);e=e.val();f=f.val();var g=""+d;if(e!=null&&
e!="")g+="&"+b+"="+escape(e);if(f!=null&&f!="")g+="&"+c+"="+escape(f);$.address.value(g)})})}function initFacetMultiButton(){$("button.facet-multi-submit",".facet-box").each(function(){var a=$(this).attr("id"),b=$(this).attr("rel");$(this).button();$(this).click(function(c){c.preventDefault();c="";c+=b;var d=[];$("input:checked","ul#"+a).each(function(){d.push($(this).val())});for(var e=d.length,f=0;f<e;++f)c+="&"+a+"="+d[f];$.address.value(c)})})}
function initFacetMoreLink(){$("a.facet-more",".facet-box").each(function(){var a=$(this).attr("id");$(this).click(function(b){b.preventDefault();$.ajax({type:"POST",cache:false,url:"/parts/moreFacet.xqy",data:a,dataType:"html",success:function(e){$("#msgcontent").html(e);$("a","#msgcontent").click(function(f){var g=$(this).attr("rel");if(g!=null&&g!=""){f.preventDefault();$.address.value(g);msgClose()}})}});var c=$("#msgblock"),d=$("#msgbox");c.css("height",$(document).height());d.css("top",b.pageY-
150);d.css("left",b.pageX);c.fadeIn();d.show("clip",{},500)})})}function msgClose(){$("#msgbox").hide("clip",{},500);$("#msgblock").fadeOut()}function initPopup(){$("#msgclose").click(function(a){a.preventDefault();msgClose()})}function fadeAndRemove(a){$(a+" > div").each(function(){$(this).fadeOut(250,function(){$(this).remove()})})}
function historyPageInit(){$.address.change(function(a){if(a.value!="/"&&a.value!=""){var b=paramVal(a.value,"page");b=="detail"&&$("#content").html("<div style='width:100%;text-align:center;'>\t<img src='/images/ajax-loader.gif'/></div>");$.ajax({type:"POST",cache:false,url:"/parts/ajaxPage.xqy",data:a.value,dataType:"html",success:function(c){$(".ui-autocomplete").remove();$("#search").html($(c).find("#search-results"));setupSearch();if(b=="search"){fadeAndRemove("#content");fadeAndRemove("#results")}else if(b==
"results"){fadeAndRemove("#content");$("#results").html($(c).find("#results-results"));$("a#kml-link").button();$("a#link-analysis-link").button()}else if(b=="detail"||b=="viz"){fadeAndRemove("#results");$("#content").html($(c).find("#content-results"));setUpEntityEvents()}b=="viz"&&$("a#viz-return-link").button();$("#facets").html($(c).find("#facet-results"));initFacetToggles();initFacetMultiButton();initFacetDate();initFacetMoreLink();setRelLinks();if(b=="results")$("#results").fadeIn(500);else if(b==
"detail"||b=="viz")$("#content").fadeIn(500)}})}})}$(document).ready(function(){initPopup();historyPageInit()});function submitSearchText(){var a=$("#search-text",".search-box"),b=a.val();a=a.attr("rel");$.address.value(a+"&t1="+escape(b))};